      ...
      },
      {
        ...
        content: (
          <div>
            ...
            {pathway ? (
              <div className="mt-5 flex flex-wrap items-center gap-2 rounded-2xl border border-border-soft bg-background p-5">
              ...
              <div className="mt-5 space-y-3">
                {insights.focusAreas.map((item, i) => (
                  <div key={item.id} className="rounded-2xl border border-border-soft bg-background p-5">
