...
const FAQS = [
  ...
  },
  {
    ...
    a: "The Guiding Stars Reading ($25) is the complete personalized learning pathway — a direct answer to the real decision you're facing (if you tell us what it is on the intake form), subjects, natural direction, a life-chapter timeline, ideal learning environment, and a weekly rhythm. The Complete Constellation Reading ($35) includes all of that plus gentle, traditional remedies personalized to your child's chart (simple, low-cost ideas only — never gemstones, never prescriptive). Already bought the first and want the remedies later? That upgrade is $15, not the full $35.",
  },
  {
